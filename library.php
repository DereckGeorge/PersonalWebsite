...
<div class="library">
    <body> 
        ...
        <table id="table">
            ...
            <tr>
                <td colspan="2">Please select the type of books</td>
            </tr>
            <tr>
                <td>
                    <div class="div1">
                        ...
                        <p></p>
                    <a href="display_non_academics.php"> <button class="btn btn1">Non Academic Books</button></a>
                        <br /><br />
                    </div>
                </td>
                <td>
                    ...
                    <p></p>
                    <a href="display_academics.php"><button class="btn btn2">Academic Books</button></a>
                    <br /><br />
                    </div>
                </td>
        </table>
