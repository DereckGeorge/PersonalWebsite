...
<html> 
	...
	<body> 
		...
		<td><?php echo $book['coursecode']; ?></td> 
		<td><?php echo $book['coursedescription']; ?></td> 
		<td><?php echo $book['department']; ?></td> 
		<td><?php echo $book['semester']; ?></td> 
		<td><?php echo $book['courseyear']; ?></td> 
		<td><?php echo $book['instructor_name']; ?></td> 
		<td><?php echo $book['results']; ?></td> 
		</tr>
		</tbody> 
	<?php 
            } }else {
